 ...
 ** 29/11/2017
 **/
public class FrmCargarAgencias extends javax.swing.JDialog {
    /**
    ...
    private int opc;
    public FrmCargarAgencias(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        btnRegresar.setContentAreaFilled(false);
        agenciabo = new AgenciaDeViajesBO();
        agencia = new AgenciaDeViajes();
        modelo = (DefaultTableModel) tbAgencias.getModel();
    }
    public FrmCargarAgencias(java.awt.Frame parent, boolean modal,int opc) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        this.opc = opc;
    ...
    private void cargarAgencias(){
        ...
        for (AgenciaDeViajes a : agencias){
            Object[] row = {
                a.getId(),
                a.getCodigo(),
                a.getNombre(),
    ...
    private void editarAgencia(){
        ...
        if (row > -1) {
            agencia = agenciabo.getAgencia((int)modelo.getValueAt(row, 0));
            FrmAgenciaDeViajes modificar = new FrmAgenciaDeViajes(null,true,agencia);
    ...
    public void eliminarAgencia(){
        ...
        if (row > -1) {
            agencia = agenciabo.getAgencia((int)modelo.getValueAt(row, 0));
            agenciabo.elmininarAgencia(agencia);
        }
        cargarAgencias();
    }
    ...
    private void initComponents() {
        ...
        tbAgencias.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Código", "Nombre", "teléfono", "Comisión"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmCargarAgencias.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmCargarAgencias dialog = new FrmCargarAgencias(new javax.swing.JFrame(), true);
