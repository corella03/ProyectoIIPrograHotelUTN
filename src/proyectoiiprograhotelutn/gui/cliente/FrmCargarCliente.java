...
import proyectoiiprograhotelutn.gui.habitacion.*;
 ...
 ** 29/11/2017
 **/
public class FrmCargarCliente extends javax.swing.JDialog {
    /**
    ...
    private int opc;
    public FrmCargarCliente(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public FrmCargarCliente(java.awt.Frame parent, boolean modal,int opc) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        this.opc = opc;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmCargarCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmCargarCliente dialog = new FrmCargarCliente(new javax.swing.JFrame(), true);
