 ...
 ** 01/11/2017
 **/
public class FrmLugar extends javax.swing.JDialog {
    /**
    ...
    public FrmLugar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public FrmLugar(java.awt.Frame parent, boolean modal, Pais pais) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        datosIniciales();
    ...
    public FrmLugar(java.awt.Frame parent, boolean modal, Provincia provincia) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        datosIniciales();
    ...
    public FrmLugar(java.awt.Frame parent, boolean modal, Canton canton) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        datosIniciales();
    ...
    public FrmLugar(java.awt.Frame parent, boolean modal, Distrito distrito) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        datosIniciales();
    ...
    public void cargarPaises(){
        ...
        for (int i = 0; i < paisbo.cargarPaises().size(); i++) {
            cbxPaisProvincia.addItem(paisbo.cargarPaises().get(i).getNombre());
        }
    }
...
//        indexPais = cbxProvinciaCanton.getSelectedIndex();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmLugar dialog = new FrmLugar(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JComboBox<String> cbxPaisProvincia;
